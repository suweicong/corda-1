...
open class TransactionBuilder(
        ...
        return try {
            ...
            when {
                ...
                rootError is ClassNotFoundException -> {
                    ((tryCount == 0) && fixupAttachments(wireTx.attachments, services))
    ...
    private fun fixupAttachments(txAttachments: List<AttachmentId>, services: ServicesForResolution): Boolean {
